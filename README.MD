...
## Cache
Testamos quatro variações de tamanho da cache L1: 8k, 16k, 32k, 64k com o intuito de encontrar a melhor configuração. Os resultados podem ser vistos abaixo:
